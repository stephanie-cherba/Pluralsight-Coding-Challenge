...
describe('sorting packages', () => {
    ...
    it('should output colon error', () => {
        expect(packageDependencies(["KittenService ", "Leetmeme: Cyberportal", "Cyberportal: Ice", "CamelCaser: KittenService", "Fraudstream: Leetmeme", "Ice: "])).toBe("Invalid - Each package must have a colon and space after, even if it has no dependencies to list")
    });
